...
// important that child classes have same method names for polymorphism
export class StandingLeft extends State {
  ...
  // #3 - state reacts to just the right type of input en each child class
  // method names have to be the same to use polymorphism
  handleInput (input) {
